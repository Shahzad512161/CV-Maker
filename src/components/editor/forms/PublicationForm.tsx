...
import { ResumeSection, PublicationItem } from '@/types/resume';
...
export const PublicationForm: React.FC<Props> = ({ section, onChange, onDone, onDelete, entryIndex = 0 }) => {
    ...
    const handleUpdateItem = (updates: Partial<PublicationItem>) => {
    ...
    return (
        <div className="bg-white rounded-[2rem] shadow-sm p-6 sm:p-10 border border-gray-100 animate-in slide-in-from-left-5 duration-300">
            <div className="flex justify-between items-center mb-8 sm:mb-10 gap-4">
                ...
                <h2 className="text-lg sm:text-xl font-black text-[#1a1b3a] tracking-tight uppercase italic truncate">Publication</h2>
            ...
            <div className="space-y-8 mb-12">
                <EditorInput
                    ...
                    placeholder="e.g. Impact of AI on Modern Logistics"
                    value={item.title}
                ...
                <EditorInput
                    ...
                    placeholder="e.g. link to journal or blog post"
                    value={item.url || ''}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <EditorInput
                        ...
                        placeholder="e.g. IEEE Journal, Nature, personal blog"
                        value={item.publisher}
                        onChange={(e) => handleUpdateItem({ publisher: e.target.value })}
                    />
                    <EditorInput
                        label="Date"
                ...
                <div>
                    ...
                    <div className="rounded-[2rem] overflow-hidden border border-gray-100 bg-gray-50 shadow-sm focus-within:ring-4 focus-within:ring-blue-500/5 focus-within:border-blue-500 transition-all">
                        <RichTextEditor
                            ...
                            placeholder="Briefly describe the publication's topic and significance..."
                        />
                    </div>
                </div>
            </div>
