                ...
                <div className="p-8 space-y-8 bg-white">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4">
                        ...
                        <div className="flex w-full sm:flex-1 gap-3">
                            <button
                                onClick={onReplace}
                                className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#F3F1EC] text-[#1A1A1A] font-black uppercase text-[10px] tracking-[0.15em] rounded-full hover:bg-[#e8e6df] transition-all"
                            >
                            ...
                            <button
                                ...
                                className="flex-1 flex items-center justify-center gap-2 py-4 bg-white border border-[#F3F1EC] text-red-500 font-black uppercase text-[10px] tracking-[0.15em] rounded-full hover:bg-red-50 hover:border-red-100 transition-all"
                            >
